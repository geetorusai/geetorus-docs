...
Limitations: one region and one capability group per connection. No workspace selection in Geetorus. Do not infer read-only access from a capability group's name. Postman's own plan limits apply.

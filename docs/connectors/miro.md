...
Reach is the authorizing Miro account's: the teams it belongs to and the boards it can open. There is no board picker in Geetorus.
...
Limitations: one Miro account per connection. No board filter inside Geetorus. Structured board objects only.

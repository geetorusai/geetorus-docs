...
- If your instance is not enrolled with Geetorus Cloud, you will need your own Google OAuth client with the **Drive API** and **Drive MCP API** enabled. [Set up your own Google OAuth app](google-setup.md) is the complete procedure — do it before you start here.
...
| **Connect with Geetorus** is not offered | The instance is not enrolled with Geetorus Cloud, or Cloud is not advertising the Drive profile | Use your own Google OAuth app |

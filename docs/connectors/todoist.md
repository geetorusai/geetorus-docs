...
Reach is the authorizing Todoist account's: its own projects, plus any shared projects it has joined. There is no project picker in Geetorus.
...
Limitations: one Todoist account per connection. No project filter inside Geetorus. Shared projects come with the account.

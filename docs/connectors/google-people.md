...
- Without Geetorus Cloud enrollment, your own Google OAuth client with the **People API** and **People MCP API** enabled. [Set up your own Google OAuth app](google-setup.md) is the complete procedure — do it before you start here.

## Connect Google People

1. Open **Connectors** and select **Google People**.
2. On the **Access** step, choose the identity and which agents may use the connection.
3. Select **Connect with Geetorus**, or **Use your own Google OAuth app** — the latter needs the client ID and secret from [Set up your own Google OAuth app](google-setup.md).
...
Directory reach is Google's decision, not Geetorus's. A Workspace administrator can limit or disable directory sharing, in which case directory searches return little or nothing even though authorization succeeded.
...
| **Connect with Geetorus** is not offered | The instance is not enrolled with Geetorus Cloud, or Cloud is not advertising the People profile | Use your own Google OAuth app |
...
| A colleague is missing from directory results | They are outside the shared directory scope your administrator configured | Nothing to fix in Geetorus |

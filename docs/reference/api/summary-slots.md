...
curl -sS \
  ...
  "https://geetorus.example.com/api/companies/{companyId}/summary-slots/project/header?scopeId={projectId}"
```
...
curl -sS -X POST \
  ...
  "https://geetorus.example.com/api/companies/{companyId}/summary-slots/project/header/generate" \
  -d '{ "scopeId": "{projectId}" }'
```

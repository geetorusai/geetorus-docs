...
curl -sS \
  ...
  "https://geetorus.example.com/api/companies/{companyId}/resource-memberships/me"
```
...
curl -sS -X PUT \
  ...
  "https://geetorus.example.com/api/companies/{companyId}/resource-memberships/me/projects/{projectId}" \
  -d '{ "state": "left" }'
```
...
curl -sS -X PUT \
  -H "Authorization: Bearer {token}" \
  -H "Content-Type: application/json" \
  "https://geetorus.example.com/api/companies/{companyId}/resource-memberships/me/agents/{agentId}" \
  -d '{ "state": "joined" }'
```
...
curl -sS -X PUT \
  -H "Authorization: Bearer {token}" \
  -H "Content-Type: application/json" \
  "https://geetorus.example.com/api/companies/{companyId}/resource-memberships/me/documents/{documentId}" \
  -d '{ "starred": true }'
```

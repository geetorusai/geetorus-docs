...
- [Ramp](./optional/finance/ramp.md) — follow Ramp's official agent playbooks (onboarding, cards, spend controls) under Geetorus's approval gates and host allowlist.
...
- [Prepare MCP Integration](./optional/software-development/prepare-mcp-integration.md) — research a new MCP or vendor integration, gate it on exact-revision human approval, then ship one governed Geetorus connector per approved connection.

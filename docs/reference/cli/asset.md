...
geetorusai asset content <asset-id> --out ./asset.bin

# Or stream the bytes to stdout (pipe or redirect them)
geetorusai asset content <asset-id> > ./asset.bin
```

...
```sh
geetorusai goal list --company-id <company-id>
geetorusai goal list --company-id <company-id> --json
```
...
```sh
geetorusai goal get <goal-id>
geetorusai goal get <goal-id> --json
```
...
```sh
geetorusai goal create --company-id <company-id> --title "Grow revenue 30% this year"
```
...
geetorusai goal create --company-id <company-id> \
...
```sh
geetorusai goal update <goal-id> --status achieved
geetorusai goal update <goal-id> --title "Grow revenue 40% this year" --description "Stretch target after Q2 beat"
```
...
geetorusai goal update <goal-id> --parent-id null --owner-agent-id <new-owner-id>

# Clear an owner entirely
geetorusai goal update <goal-id> --owner-agent-id null
```
...
```sh
geetorusai goal delete <goal-id> --yes
```

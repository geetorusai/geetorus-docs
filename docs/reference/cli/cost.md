...
| `--context <path>` | Use a specific context file instead of `~/.geetorus/context.json`. |
...
```sh
geetorusai cost summary --company-id <company-id>
geetorusai cost by-agent --company-id <company-id>
geetorusai cost by-agent-model --company-id <company-id>
geetorusai cost by-provider --company-id <company-id>
geetorusai cost by-biller --company-id <company-id>
geetorusai cost by-project --company-id <company-id>
geetorusai cost window-spend --company-id <company-id>
geetorusai cost quota-windows --company-id <company-id>
```
...
```sh
geetorusai cost issue <issue-id>
```
...
```sh
geetorusai cost event:create --company-id <company-id> --payload-json '{...}'
```
...
```sh
geetorusai finance event:create --company-id <company-id> --payload-json '{...}'
geetorusai finance events --company-id <company-id>
geetorusai finance summary --company-id <company-id>
geetorusai finance by-biller --company-id <company-id>
geetorusai finance by-kind --company-id <company-id>
```
...
```sh
geetorusai budget overview --company-id <company-id>
geetorusai budget policy:upsert --company-id <company-id> --payload-json '{...}'
geetorusai budget company:update --company-id <company-id> --payload-json '{...}'
geetorusai budget agent:update <agent-id> --payload-json '{...}'
geetorusai budget incident:resolve <incident-id> --company-id <company-id>
```
...
```sh
geetorusai budget incident:resolve <incident-id> --company-id <company-id>
geetorusai budget incident:resolve <incident-id> --company-id <company-id> --payload-json '{"...":"..."}'
```

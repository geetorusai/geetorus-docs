...
```sh
geetorusai project list --company-id <company-id>
geetorusai project get <project-id-or-shortname> [--company-id <company-id>]
geetorusai project create --company-id <company-id> --name "Launch Site" [--goal-ids <id1,id2>] [--lead-agent-id <agent-id>]
geetorusai project update <project-id-or-shortname> --status in_progress [--company-id <company-id>]
geetorusai project delete <project-id-or-shortname> --yes [--company-id <company-id>]
```
...
```sh
geetorusai project list --company-id <company-id>
geetorusai project list --company-id <company-id> --json
```
...
```sh
geetorusai project get <project-id-or-shortname>
geetorusai project get launch-site --company-id <company-id>
geetorusai project get <project-id> --json
```
...
```sh
geetorusai project create --company-id <company-id> --name "Launch Site"
```
...
```sh
geetorusai project update <project-id-or-shortname> --status in_progress
geetorusai project update launch-site --company-id <company-id> --name "Launch v2"
```
...
geetorusai project update <project-id> --lead-agent-id null --archived-at null

# Archive a project
geetorusai project update <project-id> --archived-at 2026-06-01T00:00:00Z
```
...
```sh
geetorusai project delete <project-id-or-shortname> --yes
geetorusai project delete launch-site --company-id <company-id> --yes
```
...
These fields shape how an agent's work actually runs. Remember that the agent's real execution happens server-side in the Geetorus runtime and adapters — the CLI sets these defaults; the server enforces them.
...
```sh
geetorusai project update <project-id> \
...
```sh
geetorusai project update <project-id> --execution-workspace-policy-json null
```

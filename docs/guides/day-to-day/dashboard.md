...
![The Geetorus dashboard showing the current overview cards, charts, recent activity, and recent tasks](../../user-guides/screenshots/light/dashboard/dashboard-overview.png)

---

## Agents Section

At the top of the dashboard, Geetorus shows your live agent activity and a set of overview cards. This is the quickest way to tell whether work is moving.

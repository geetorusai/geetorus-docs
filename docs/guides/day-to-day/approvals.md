...
The first approvals most people encounter in Geetorus are:
...
- For a strategy: Geetorus queues the requester to wake automatically, so the follow-up run usually appears shortly after approval.

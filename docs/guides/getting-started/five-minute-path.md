...
seo_description: Install Geetorus, create a company, hire a CEO agent, and approve its first strategy — a working AI company in about five minutes.
geetorus_version: v2026.831.1
---

# Quickstart Path

The shortest route from a running Geetorus instance to an agent that has just completed work for you. After Geetorus is installed, the path takes about 5 minutes: create a company, hire a CEO agent, approve its first strategy, watch tasks land on the board.

![The Geetorus dashboard showing an active CEO agent, a budget bar, and recent activity](../../user-guides/screenshots/light/dashboard/dashboard-overview.png)

---

## What this is, briefly

A Geetorus company is a self-contained AI organisation — one goal, a team of agents, a task board, a budget. The CEO is the first agent you hire. It reads your goal, proposes a strategy, and — once you approve it — starts creating tasks and moving them across the board.
...
## Before the path: install Geetorus

Install Geetorus and grab an AI provider key. This is one-time setup and lives outside the 5-minute clock — depending on what you already have, expect 3–10 minutes.
...
> **Warning:** Agents make API calls that cost money. Plan on spending $5–20 to play with the product, $20–100/month for an active company. Set per-agent and company budgets before enabling heartbeats — Geetorus pauses agents automatically when they hit 100%.
...
Three steps after Geetorus is running. Allow ~5–11 minutes total.

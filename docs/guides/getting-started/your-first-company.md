...
A Company in Geetorus is the container for everything: your goal, your team of agents, all the tasks they work through, and the budget that keeps spending under control. Before any agents can do anything, they need a company to work inside.

Think of it like setting up a new startup. You open a workspace, write down what you're trying to build, decide how much runway you're working with, and then you can start hiring. Creating a company in Geetorus is that first step.
...
Make sure Geetorus is installed and running. If you haven't done that yet, start with the [Installation guide](./installation.md).

---

1. **Open the setup wizard**

   When you first open Geetorus, it drops you straight into the setup wizard. If you're adding another one later, open the organization switcher at the top of the sidebar and choose **Create new organization…**.
...
3. **Click Continue**
   ...
   Click **Continue**. Geetorus creates the organization and takes you straight to the next screen — hiring your first agent, which the [next guide](./your-first-agent.md) covers in full.
...
You can create as many companies as you want in Geetorus. Each is entirely self-contained — separate agents, tasks, goals, and budgets. This is useful if you want to run different AI-powered initiatives in parallel: a development company and a marketing company, for example, with separate teams and budgets for each.

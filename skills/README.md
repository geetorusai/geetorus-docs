...
|---|---|---|
| [`sync-docs`](sync-docs/SKILL.md) | Keeps these docs in lockstep with the parent `geetorusai/geetorus` codebase. Two modes: nightly (tracks parent `main`, preview deploy) and release (on parent tag, merges to `main`, ships live). | `/sync-docs` |

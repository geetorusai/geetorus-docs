...
const outDir = mkdtempSync(join(tmpdir(), "geetorus-docs-crawlable-links-"));
const SITE_ORIGIN = "https://docs.geetorus.ing";
...
const manifestRoutes = [...sitemapForNav.matchAll(/<loc>https:\/\/docs\.geetorus\.ing(\/[^<]*)<\/loc>/g)]
  .map((match) => match[1])

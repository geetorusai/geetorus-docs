...
// release tag. Under Geetorus's channel model our `nightly` preview tracks
...
//        [--base main] [--head HEAD] [--repo geetorusai/geetorus] [--json]
...
function parseArgs(argv) {
  const out = { base: "main", head: "HEAD", repo: "geetorusai/geetorus", json: false };

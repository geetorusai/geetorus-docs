...
- **`main` (docs)** tracks the latest **released** geetorus tag (e.g. `v2026.512.0`). Deploys to docs.geetorus.ing.
...
- `parent_paths` — globs in github.com/geetorusai/geetorus to watch.

...
const expectedTrails = new Map([
  ...
  [
    "reference/skills/bundled/geetorus-operations/issue-triage.md",
    ["Skills", "Bundled", "Geetorus Operations", "Issue Triage"],
  ],
  [
    "reference/skills/bundled/geetorus-operations/task-planning.md",
    ["Skills", "Bundled", "Geetorus Operations", "Task Planning"],
  ],
  [

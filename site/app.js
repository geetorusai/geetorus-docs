...
const SEO_SITE_NAME = 'Geetorus Docs';
const SEO_DEFAULT_TITLE = 'Geetorus Docs';
const SEO_DEFAULT_DESCRIPTION = 'Guides, references, and walkthroughs for running Geetorus, an AI company operating system for agent teams, governance, budgets, and workflows.';
...
function updatePageSeo(page, md) {
  ...
  setSeoMetadata({
    title: `${authoredTitle || page.title} | Geetorus Docs`,
...
/* ─── GitHub star count (mirrors geetorus.ing) ────────────────────────── */
(function () {
  const REPO = 'geetorusai/geetorus';
...
const DOCS_REPO_SLUG = 'geetorusai/geetorus-docs';
...
// wraps wherever the words run out ("Connect with Geetorus · Your / own OAuth
